...
use super::super::sev_status::{SevStatusFlags, MSR_AMD_SEV};
use crate::mm;
...
use super::super::rmpadjust::{rmpadjust, RmpAdjustment};
...
impl VMSaveArea {
    ...
    pub fn init_default_values(&mut self) {
        ...
        self.cr4.0 = Cr4::read().bitand(Cr4Flags::MACHINE_CHECK_EXCEPTION);
