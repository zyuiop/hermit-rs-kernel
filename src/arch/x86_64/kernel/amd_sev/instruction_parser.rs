...
use crate::arch::kernel::amd_sev::ghcb_protocol::ghcb_msr::{vmgexit, GhcbMsrRequest};
...
use crate::env::kernel::amd_sev::ghcb_protocol::ghcb::GhcbU64Field;
use crate::env::kernel::amd_sev::ghcb_protocol::ghcb_msr::ghcb_request_exit;
use crate::env::kernel::amd_sev::opcodes::{instruction_prefix};
use crate::env::kernel::amd_sev::opcodes::opcode::KnownOpcode;
use crate::env::kernel::amd_sev::vc_handler::InterruptStackFrame;
...
impl ModRmInfo {
    ...
    pub unsafe fn finalize_from_instruction(self, instruction_data: &mut InstructionData, frame: &InterruptStackFrame) -> (ExtendedRegister, VirtAddr) {
        ...
        let register_or_memory = self.finalize_rm_from_instruction(instruction_data, frame);
