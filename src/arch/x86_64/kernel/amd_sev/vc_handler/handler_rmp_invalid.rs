...
use crate::arch::kernel::amd_sev::pvalidate::pvalidate;
use crate::arch::kernel::amd_sev::vc_handler::InterruptStackFrame;
use crate::arch::mm::paging::{identity_mapped_page_table, LargePageSize};
...
pub fn handle_rmp_invalid(_: &mut InterruptStackFrame) {
	...
	let page_size = match translate_result {
