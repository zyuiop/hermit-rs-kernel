...
pub mod opcode {
    ...
    /*
    const HAS_MODRM: [KnownOpcode; 6] = [
        KnownOpcode::MOV_RM_REG_BYTE,
        KnownOpcode::MOV_RM_REG,
        KnownOpcode::MOVZ_REG_RM_BYTE,
        KnownOpcode::MOVZ_REG_RM,
        KnownOpcode::MOV_REG_RM_BYTE,
        KnownOpcode::MOV_REG_RM,
    ];
     */
...
pub mod instruction_prefix {
    ...
    impl RegisterExtensionPrefix {
        pub fn from_opcode(opcode: u8) -> Option<RegisterExtensionPrefix> {
            if opcode >= instruction_prefix::REX_PREFIX_START && opcode <= instruction_prefix::REX_PREFIX_END {
