use crate::fd::{get_object, ObjectInterface};
use crate::{fd, io};
use crate::io::Error::EINVAL;
...
fn socket_handle_ioctl(this: &dyn ObjectInterface, cmd: crate::fs::ioctl::IoCtlCall, argp: *mut core::ffi::c_void,) -> io::Result<()> {
